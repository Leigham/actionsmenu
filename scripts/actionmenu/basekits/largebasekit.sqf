...
_object addItemCargoGlobal ["ItemLockbox",3];
_object addItemCargoGlobal ["KitWoodFloor",24];
_object addItemCargoGlobal ["KitStudWall",24];
_object addItemCargoGlobal ["EnergyPack",6];
_object addItemCargoGlobal ["ItemCorrugated",24];
_object addItemCargoGlobal ["KitFoundation",10];
